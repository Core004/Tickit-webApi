    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyPriorities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompanyPriorities_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyPriorities_Priorities_PriorityId",
            ...
            migrationBuilder.CreateTable(
                name: "CompanyProductPlans",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CompanyProductId = table.Column<int>(type: "int", nullable: false),
                    ProductPlanId = table.Column<int>(type: "int", nullable: false),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyProductPlans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompanyProductPlans_CompanyProducts_CompanyProductId",
                        column: x => x.CompanyProductId,
                        principalTable: "CompanyProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyProductPlans_ProductPlans_ProductPlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketCustomFields_Tickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "Tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketHistory_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyPriorities_CompanyId",
                table: "CompanyPriorities",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyPriorities_PriorityId",
                table: "CompanyPriorities",
                column: "PriorityId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyProductPlans_CompanyProductId",
                table: "CompanyProductPlans",
                column: "CompanyProductId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyProductPlans_ProductPlanId",
                table: "CompanyProductPlans",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketCustomFields_TicketId",
                table: "TicketCustomFields",
                column: "TicketId");

            migrationBuilder.CreateIndex(
                name: "IX_TicketHistory_CreatedById",
                table: "TicketHistory",
                column: "CreatedById");
